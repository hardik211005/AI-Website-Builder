...
`
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: `I've enhanced your request to be more specific and actionable for a web developer: "${enhancedPrompt}"`,
                projectId
            }
        });
        await prisma.conversationmodel.create({
            data: {
                role: 'assistant',
                content: 'Now making changes to your website based on the enhanced request...',
                projectId
            }
        });
...
`
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: "I've made the changes to your website based on your request. Here's the updated code:",
                projectId
            }
        });
...
export const rollbackToVersion = async (req: Request, res: Response) => {
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: "I've rolled your website back to the selected version.",
                projectId
            }
            })
